<h2><a href="https://leetcode.com/problems/single-row-keyboard/?envType=problem-list-v2&envId=string">1123. Single-Row Keyboard</a></h2><h3>Easy</h3><hr><p>There is a special keyboard with <strong>all keys in a single row</strong>.</p>
