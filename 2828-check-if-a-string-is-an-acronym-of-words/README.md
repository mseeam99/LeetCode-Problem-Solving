<h2><a href="https://leetcode.com/problems/check-if-a-string-is-an-acronym-of-words/?envType=problem-list-v2&envId=string">2977. Check if a String Is an Acronym of Words</a></h2><h3>Easy</h3><hr><p>Given an array of strings <code>words</code> and a string <code>s</code>, determine if <code>s</code> is an <strong>acronym</strong> of words.</p>
